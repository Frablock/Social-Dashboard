...
<div class="grid grid-rows-3 gap-4">
    <div class="grid grid-cols-1 row-span-1 gap-4">
        <div class="col-span-1"><AreaCard title="Progress" data="{compareSeries}"/></div>
    </div>
    <div class="grid grid-cols-2 row-span-2 gap-4">
        <div class="col-span-1"><LeaderCard title="All Social Media"/></div>
        <div class="col-span-1"><LeaderCard title="Best Performance"/></div>
    </div>
</div>